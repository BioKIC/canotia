					...
					<tr>
						...
						<td width="500" bgcolor="#FFFFFF" valign="top">
							...
							<div style="margin:20px 0px;padding:5px;background-color:#335423">
								<ul>
									<li>
										<a href="volumes/vol16/SaleroRanchFlora.pdf" target="_blank" style="color:#FFFFFF;">
											Diversity in a Grassland: Flora of the Salero Ranch, Santa Cruz County, Arizona
										</a>
									</li>
								</ul>
								<div style="margin:15px 40px;color:#FFFFFF;">
									By Susan Davis Carnahan
								</div>
							</div>
							<div style="margin:20px 0px;padding:5px;background-color:#335423">
								<ul>
									<li>
										<span style="color:#FFFFFF;"><a href="volumes/vol16/SaleroRanchGallery.pdf" target="_blank">Salero Ranch Flora Supplement</a>: Image gallery of 840 photographs</span>
									</li>
								</ul>
								<div style="margin:15px 40px;color:#FFFFFF;">
									By Susan Davis Carnahan
